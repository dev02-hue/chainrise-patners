...
const CryptoCurrencyTicker1 = () => {
  ...
  return (
    <div className="bg-gray-900 border-y border-gray-800 py-4 overflow-hidden dark:border-gray-200 h-16 flex items-center  ">
...
export default CryptoCurrencyTicker1;