...
const navItems = [
  { name: "Dashboard", href: "/dashboard", icon: <FiHome className="mr-2" /> },
  {
    ...
    dropdown: [
      { name: "Profile Setting", href: "/account/profile-setting" },
      { name: "My Referral", href: "/account/my-referral" },
      { name: "All Wallet Addresses", href: "/account/all-wallets" },
      { name: "New Wallet Address", href: "/account/new-wallets" },
    ],
  },
  {
    name: "Deposit",
    ...
    dropdown: [
      { name: "All Deposit", href: "/deposit/all" },
      { name: "New Deposit", href: "/deposit/new" },
    ],
  },
  {
    name: "Investment",
    ...
    dropdown: [
      { name: "All Investment", href: "/investment/all" },
      { name: "New Investment", href: "/investment/new" },
    ],
  },
  {
    name: "Withdrawal",
    ...
    dropdown: [
      { name: "All Withdrawals", href: "/withdrawal/all" },
      { name: "New Withdrawal", href: "/withdrawal/new" },
    ],
  },
